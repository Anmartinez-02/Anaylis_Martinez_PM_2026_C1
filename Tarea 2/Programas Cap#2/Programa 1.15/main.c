...
#include <stdlib.h>
/* Spa.
El programa, al recibir como datos el tipo de tratamiento, la edad y el número de dias de internación de un cliente en un spa, calcula el costo total del tratamiento.
